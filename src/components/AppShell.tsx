...
const nav = [
  ...
  { to: "/map", label: "Intelligence Map", icon: Globe2 },
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="no-print h-12 border-b border-border bg-card/60 backdrop-blur flex items-center justify-between px-4 md:px-6">
